...
public class CurrencyConverterUtilTest extends InstrumentationTestCase{
    ...
    public void testConvertEuroToOtherCurrency() throws Exception{
        ...
        final String result = CurrencyConverterUtil.convertEuroCurrency(input, CurrencyConverterUtil.Type.EURO_TO_OTHER, GRD_RATE, 2);
    ...
    public void testConvertOtherToEuroCurrency() throws Exception{
        ...
        final String result = CurrencyConverterUtil.convertEuroCurrency(input, CurrencyConverterUtil.Type.OTHER_TO_EURO, GRD_RATE, 2);
        assertEquals(expected,result);
    }
    ...
    public void testConvertOtherToOtherCurrency() throws Exception{
        ...
        final String result = CurrencyConverterUtil.convertOtherCurrency(input, USD_RATE, GRD_RATE, 2);
        assertEquals(expected,result);
    }
}
